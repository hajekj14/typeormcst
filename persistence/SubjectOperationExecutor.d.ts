...
export declare class SubjectOperationExecutor {
    ...
    constructor(connection: Connection, transactionEntityManager: EntityManager, queryRunnerProvider: QueryRunnerProvider);
    /**
     * Executes all operations over given array of subjects.
     * Executes queries using given query runner.
     */
    execute(subjects: Subject[]): Promise<void>;
    /**
     ...
     */
    private collectColumnsAndValues(metadata, entity, date, parentIdColumnValue, discriminatorValue, alreadyInsertedSubjects);
    /**
